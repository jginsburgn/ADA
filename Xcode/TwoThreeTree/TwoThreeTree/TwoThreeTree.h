...
#ifndef __TwoThreeTree__
#define __TwoThreeTree__

#include <iostream>
#include "ThreeFourNode.h"
...
template <class T>
TwoThreeTree<T>::TwoThreeTree(Node<T> *r){
    root = r;
}
...
template <class T>
void TwoThreeTree<T>::balanceRemoval(Node<T>* node) {
...
template <class T>
void TwoThreeTree<T>::case1Left(Node<T>* node, Node<T>* parent, Node<T>* sibling) {
...
template <class T>
void TwoThreeTree<T>::case1Right(Node<T>* node, Node<T>* parent, Node<T>* sibling) {
	sibling->setIsFull(false);
	node->setInfoA(parent->getInfoA());
...
template <class T>
T TwoThreeTree<T>::findSuccessor(Node<T>* node, T key) {
	Node<T>* p;
	if (node->getInfoA() == key)	
		p = node->getCenter();
	else
...
template <class T>
Node<T>* TwoThreeTree<T>::getRoot(){
    return root;
}

template <class T>
void TwoThreeTree<T>::inOrder(){
    return inOrder(root);
}

template <class T>
void TwoThreeTree<T>::inOrder(Node<T> *node){
    if (node ==nullptr){
        return;
    }
...
template <class T>
void TwoThreeTree<T>::postOrder(){
    return postOrder(root);
}

template <class T>
void TwoThreeTree<T>::postOrder(Node<T> *node){
    if (node ==nullptr){
        return;
    }
...
template <class T>
void TwoThreeTree<T>::insert(T e){
...
template <class T>
void TwoThreeTree<T>::splitNode(T e, Node<T> *node, Node<T> *pCLKey, Node<T> *pCRKey){
    ...
    TwoThreeNode<T> *nodeAux = new TwoThreeNode<T>(node, e, pCLKey, pCRKey);
...
template <class T>
Node<T>* TwoThreeTree<T>::search(T e){
...
template <class T>
int TwoThreeTree<T>::height(Node<T>* node) {
	if (!node)
		return -1;
	else
...
template <class T>
int TwoThreeTree<T>::depth(Node<T>* node) {
	if (!node->getParent())
		return 0;
...
template <class T>
int TwoThreeTree<T>::level(Node<T>* node) {
	return depth(node) + 1;
}
